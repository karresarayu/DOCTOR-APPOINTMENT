  ...
  return (
    <div>
      ...
      <div className="flex flex-col md:flex-row mb-20 gap-3">
        <div className="border px-10 md:px-16 py-8 sm:py-16  flex flex-col gap-5 text-[15px] hover:bg-violet-500 hover:text-white transition-all duration-200 cursor-pointer ">
          <b>EFFICIENCY:</b>
